...
wget https://github.com/LuckyCoinProj/luckycoinV3/releases/download/v3.0.2/Node-v3.0.2-linux.zip -O Node-v3.0.2-linux.zip
unzip Node-v3.0.2-linux.zip
rm Node-v3.0.2-linux.zip
